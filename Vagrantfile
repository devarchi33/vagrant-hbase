...
Vagrant.configure(2) do |config|
  ...
  config.vm.provision "file", source: "./devarchi-hbase-install.sh", destination: "devarchi-hbase-install.sh"
  config.vm.provision "file", source: "./devarchi-java-env-install.sh", destination: "devarchi-java-env-install.sh"
